...
import { notFoundPage, saltRoundsConst } from '../../constants/constant.js';
...
const updateProfileGet = async (req, res) => {
  try {
    ...
    res.render(
      './client/pages/user/profile.view.ejs',
      {
...
const historyGet = async (req, res) => {
  try {
    ...
    res.render(
      './client/pages/user/history.view.ejs',
      {
